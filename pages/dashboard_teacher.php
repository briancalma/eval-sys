<div class="card">
    ...
    <div class="body">
        <div class="row">
            <div class="col-xs-12"> 
                <center>
                    <img src="../images/Teacher.png" width="150px" height="150px">
                </center>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-xs-4"></div>
            <div class="col-xs-4">
                 <a href="../pages/teacher_main_evaluation_page.php" class="btn btn-block waves-effect btn-lg btn-warning">Evaluate PEER</a>
            </div>
        </div>
...
<!-- <?php require_once 'teacher_list_from_department.php'; ?> -->
	

<!-- 
	  Show a list of all faculty member specifically in each department 
...
<div class="modal fade" id="evalModalTeacher" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
         <form method="POST" action="../controller/insert_evaluation.php" id="evaluate_teacher_self_form">
        ...
        <div class="modal-content">
            <form method="POST" action="../controller/update_teacher_info.php">
              ...
              <div class="modal-body">
                  ...
                  <?php 
                      $teacher_data = $conn->query("SELECT * FROM `tbl_teacher_record` WHERE `teacher_id` = '$username'");
                  ...
                  <div class="row">
                     <div class="col-xs-6">
                          <div class="input-group">
                              ...
                              <div class="form-line">
                                  <input type="text" class="form-control" id="usernameTxt" name="teacher_id" minlength="8" maxlength="8" placeholder="USER ID" value="<?php echo $teacher_data["teacher_id"] ?>"  onmouseout="checkIfAccountExist('Teacher')" required autofocus>

                                  <input type="hidden" name="old_teacher_id" value="<?php echo $teacher_data["teacher_id"] ?>">
                              </div>
                          </div>
                      </div>
                      <div class="col-xs-6">
